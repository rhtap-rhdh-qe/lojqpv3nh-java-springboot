...
export GITOPS_REPO_URL=https://github.com/rhtap-rhdh-qe/lojqpv3nh-java-springboot-gitops
...
export REKOR_HOST=${REKOR_HOST-https://rekor-server-rhtap-tas.apps.rosa.kx-3571697f6f.vzaw.p3.openshiftapps.com}
...
export TUF_MIRROR=${TUF_MIRROR-https://tuf-rhtap-tas.apps.rosa.kx-3571697f6f.vzaw.p3.openshiftapps.com}
